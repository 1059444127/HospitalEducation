...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#BasesRealName").val("<%=(Session["loginModel"] as GP_Login).real_name%>");
            $("#BasesName").val("<%=(Session["loginModel"] as GP_Login).name%>");
            $("#TrainingBaseName").val("<%=(Session["loginModel"] as GP_Login).training_base_name%>");
            $("#TrainingBaseCode").val("<%=(Session["loginModel"] as GP_Login).training_base_code%>");
            $("#ProfessionalBaseName").val("<%=(Session["loginModel"] as GP_Login).professional_base_name%>");
            $("#ProfessionalBaseCode").val("<%=(Session["loginModel"] as GP_Login).professional_base_code%>");
